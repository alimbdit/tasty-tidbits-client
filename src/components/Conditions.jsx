  ...
  return (
    <div className="bg-opacity-25 bg-red-100">
      <div className="container">
        ...
        <h2 className="text-2xl font-medium text-red-500 text-center mb-8">
          Welcome to our food website. By using our website, you agree to comply
        ...
        <ul className="list-decimal mb-20 text-lg text-gray-600 space-y-1">
          <li>
